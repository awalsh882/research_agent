...
> **Tip:** For more information on Claude Code installation, see [Claude Code setup](https://docs.anthropic.com/en/docs/claude-code/setup).
...
> **Note:** If you see "Claude Code not found", [install Claude Code](#step-1-install-claude-code) and restart your terminal. For "API key not found", [set your API key](#step-4-set-your-api-key). See the [full troubleshooting guide](https://docs.anthropic.com/en/docs/claude-code/troubleshooting) for more help.
